...
const Navbar = ({ onNavigate }) => {
  ...
  return (
    <div className="main" style={{ boxShadow: "0 1px 30px 2px rgb(0, 0, 23)" }}>
      {/* Admin Panel Heading */}
      <div
        style={{
            ...
            <li
              ...
              className={`p-2 border rounded-md border-b-2 border-black shadow-[2px_2px_3px_black] transition-all transform active:scale-95 active:translate-y-0.5 ${
                activeButton === item
                  ...
                  : "bg-gray-900 font-extrabold hover:bg-gray-500 hover:scale-110 hover:translate-y-1" // Styles for non-active button
              }`}
